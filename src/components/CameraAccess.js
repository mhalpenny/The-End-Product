    ...
    return (
      <div>
        <div id='previewContainer'>{playerORImage}</div>
          <button className='endButton' id='camPhotoBtn' onClick={this.initializeMedia}>Take Photo</button>
          <button className='endButton' id='camSnapBtn' onClick={this.capturePicture}>Capture</button>
          <button className='endButton' id='camSwitchBtn' onClick={this.switchCamera}>Switch</button>
      </div>
    );
  }
}
